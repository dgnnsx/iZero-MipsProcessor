...
module LCD_display_string(clk, wlcd, index, PC, OPCODE, DATA, out);
	...
	// ------------- Menus do jogo: Toupeira Battleship ------------- //
	localparam [CHAR_WIDTH-1:0] BATTLESHIP_PRESS_TO_ATTACK = 8'd40;
	localparam [CHAR_WIDTH-1:0] BATTLESHIP_SELECT_ROW = 8'd41;
	localparam [CHAR_WIDTH-1:0] BATTLESHIP_SELECT_COLUMN = 8'd42;
	localparam [CHAR_WIDTH-1:0] BATTLESHIP_SHOW_ATTACKED = 8'd43;
	localparam [CHAR_WIDTH-1:0] BATTLESHIP_ALREADY_ATTACKED = 8'd44;
	...
	localparam  OPCODE_LCD_DATA = 6'b100101;
	...
	wire [CHAR_WIDTH-1:0] BATTLESHIP_PRESS_TO_ATTACK_STRING [0:LCD_WIDTH-1];
	wire [CHAR_WIDTH-1:0] BATTLESHIP_SELECT_ROW_STRING [0:LCD_WIDTH-1];
	wire [CHAR_WIDTH-1:0] BATTLESHIP_SELECT_COLUMN_STRING [0:LCD_WIDTH-1];
	wire [CHAR_WIDTH-1:0] BATTLESHIP_SHOW_ATTACKED_STRING [0:LCD_WIDTH-1];
	wire [CHAR_WIDTH-1:0] BATTLESHIP_ALREADY_ATTACKED_STRING [0:LCD_WIDTH-1];
	
	reg [CHAR_WIDTH:0] STATE_LCD_CHANGE;
	reg [31:0] STATE_LCD_DATA;
	...
	// BATTLESHIP - SQUARE ATTACKED
	reg	[7:0] SQUARE_DEZENA;
	reg	[7:0] SQUARE_UNIDADE;
	...
	reg [3:0] dezena_sqr; // Digito da dezena
	reg [3:0] unidade_sqr; // Digito da unidade

	reg [31:0] aux; // Auxiliar no caso de negativo
	reg [31:0] aux_sqr; // Auxiliar no caso de negativo
	integer i; // Contador
	...
	// Algoritmo de conversao binario para 2BCD
	always @ (STATE_LCD_DATA) begin
		aux_sqr = 32'b0;
		dezena_sqr = 4'b0000;
		unidade_sqr = 4'b0000;
		if(STATE_LCD_DATA[15] == 0) begin
			for(i = 15; i >=0; i = i-1) begin
				if(dezena_sqr >= 5) dezena_sqr = dezena_sqr + 4'd3;
				if(unidade_sqr >= 5) unidade_sqr = unidade_sqr + 4'd3;
				dezena_sqr = dezena_sqr << 1;
				dezena_sqr[0] = unidade_sqr[3];
				unidade_sqr = unidade_sqr << 1;
				unidade_sqr[0] = STATE_LCD_DATA[i];
			end
		end
		else begin
			aux_sqr = ~(STATE_LCD_DATA) + 8'b00000001;
			for(i = 15; i >=0; i = i-1) begin
				if(dezena_sqr >= 5) dezena_sqr = dezena_sqr + 4'd3;
				if(unidade_sqr >= 5) unidade_sqr = unidade_sqr + 4'd3;
				dezena_sqr = dezena_sqr << 1;
				dezena_sqr[0] = unidade_sqr[3];
				unidade_sqr = unidade_sqr << 1;
				unidade_sqr[0] = aux_sqr[i];
			end
		end
		SQUARE_DEZENA <= display(dezena_sqr);
		SQUARE_UNIDADE <= display(unidade_sqr);
	end
	...
	// KERNEL MENU HD ADD SECOND PART
	// Line 1
	...
	assign KERNEL_MENU_HD_ADD_THIRD_PART_STRING[5'd31] = CHAR_SPACE;
		...
		// KERNEL MENU HD ADD FOURTH PART
	// Line 1
	...
	// BATTLESHIP PRESS TO ATTACK
	// Line 1
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd0] = CHAR_P;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd1] = CHAR_R;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd2] = CHAR_E;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd3] = CHAR_S;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd4] = CHAR_S;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd5] = CHAR_SPACE;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd6] = CHAR_I;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd7] = CHAR_N;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd8] = CHAR_S;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd9] = CHAR_E;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd10] = CHAR_R;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd11] = CHAR_T;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd12] = CHAR_SPACE;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd13] = CHAR_T;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd14] = CHAR_O;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd15] = CHAR_COLLON;
	// Line 2
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd16] = CHAR_SPACE;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd17] = CHAR_SPACE;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd18] = CHAR_SPACE;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd19] = CHAR_SPACE;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd20] = CHAR_HYPHEN;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd21] = CHAR_A;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd22] = CHAR_T;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd23] = CHAR_T;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd24] = CHAR_A;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd25] = CHAR_C;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd26] = CHAR_K;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd27] = CHAR_HYPHEN;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd28] = CHAR_SPACE;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd29] = CHAR_SPACE;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd30] = CHAR_SPACE;
	assign BATTLESHIP_PRESS_TO_ATTACK_STRING[5'd31] = CHAR_SPACE;
	
	// BATTLESHIP SELECT ROW
	// Line 1
	assign BATTLESHIP_SELECT_ROW_STRING[5'd0] = CHAR_S;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd1] = CHAR_E;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd2] = CHAR_L;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd3] = CHAR_E;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd4] = CHAR_C;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd5] = CHAR_T;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd6] = CHAR_SPACE;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd7] = CHAR_P;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd8] = CHAR_O;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd9] = CHAR_S;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd10] = CHAR_I;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd11] = CHAR_T;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd12] = CHAR_I;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd13] = CHAR_O;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd14] = CHAR_N;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd15] = CHAR_COLLON;
	// Line 2
	assign BATTLESHIP_SELECT_ROW_STRING[5'd16] = CHAR_I;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd17] = CHAR_N;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd18] = CHAR_S;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd19] = CHAR_E;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd20] = CHAR_R;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd21] = CHAR_T;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd22] = CHAR_SPACE;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd23] = CHAR_R;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd24] = CHAR_O;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd25] = CHAR_W;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd26] = CHAR_DOT;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd27] = CHAR_DOT;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd28] = CHAR_DOT;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd29] = CHAR_SPACE;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd30] = CHAR_SPACE;
	assign BATTLESHIP_SELECT_ROW_STRING[5'd31] = CHAR_SPACE;
	
	// BATTLESHIP SELECT COLUMN
	// Line 1
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd0] = CHAR_S;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd1] = CHAR_E;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd2] = CHAR_L;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd3] = CHAR_E;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd4] = CHAR_C;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd5] = CHAR_T;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd6] = CHAR_SPACE;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd7] = CHAR_P;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd8] = CHAR_O;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd9] = CHAR_S;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd10] = CHAR_I;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd11] = CHAR_T;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd12] = CHAR_I;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd13] = CHAR_O;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd14] = CHAR_N;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd15] = CHAR_COLLON;
	// Line 2
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd16] = CHAR_I;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd17] = CHAR_N;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd18] = CHAR_S;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd19] = CHAR_E;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd20] = CHAR_R;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd21] = CHAR_T;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd22] = CHAR_SPACE;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd23] = CHAR_C;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd24] = CHAR_O;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd25] = CHAR_L;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd26] = CHAR_U;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd27] = CHAR_M;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd28] = CHAR_N;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd29] = CHAR_DOT;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd30] = CHAR_DOT;
	assign BATTLESHIP_SELECT_COLUMN_STRING[5'd31] = CHAR_DOT;
	
	// BATTLESHIP SHOW ATTACKED
	// Line 1
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd0] = CHAR_A;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd1] = CHAR_T;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd2] = CHAR_T;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd3] = CHAR_A;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd4] = CHAR_C;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd5] = CHAR_K;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd6] = CHAR_SPACE;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd7] = CHAR_C;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd8] = CHAR_O;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd9] = CHAR_M;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd10] = CHAR_P;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd11] = CHAR_L;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd12] = CHAR_E;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd13] = CHAR_T;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd14] = CHAR_E;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd15] = CHAR_D;
	// Line 2
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd16] = CHAR_S;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd17] = CHAR_Q;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd18] = CHAR_U;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd19] = CHAR_A;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd20] = CHAR_R;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd21] = CHAR_E;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd22] = CHAR_COLLON;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd23] = SQUARE_DEZENA;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd24] = SQUARE_UNIDADE;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd25] = CHAR_SPACE;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd26] = CHAR_SPACE;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd27] = CHAR_SPACE;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd28] = CHAR_SPACE;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd29] = CHAR_SPACE;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd30] = CHAR_SPACE;
	assign BATTLESHIP_SHOW_ATTACKED_STRING[5'd31] = CHAR_SPACE;
	
	// BATTLESHIP ALREADY ATTACKED
	// Line 1
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd0] = CHAR_SPACE;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd1] = CHAR_I;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd2] = CHAR_N;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd3] = CHAR_V;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd4] = CHAR_A;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd5] = CHAR_L;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd6] = CHAR_I;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd7] = CHAR_D;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd8] = CHAR_SPACE;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd9] = CHAR_S;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd10] = CHAR_Q;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd11] = CHAR_U;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd12] = CHAR_A;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd13] = CHAR_R;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd14] = CHAR_E;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd15] = CHAR_SPACE;
	// Line 2
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd16] = CHAR_A;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd17] = CHAR_L;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd18] = CHAR_R;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd19] = CHAR_E;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd20] = CHAR_A;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd21] = CHAR_D;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd22] = CHAR_Y;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd23] = CHAR_SPACE;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd24] = CHAR_A;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd25] = CHAR_T;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd26] = CHAR_T;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd27] = CHAR_A;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd28] = CHAR_C;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd29] = CHAR_K;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd30] = CHAR_E;
	assign BATTLESHIP_ALREADY_ATTACKED_STRING[5'd31] = CHAR_D;
	...
	always @ (posedge clk) begin
		if (wlcd) begin
			...
			STATE_LCD_DATA <= OPCODE == OPCODE_LCD_DATA ? DATA : STATE_LCD_DATA;
	...
	always @ (posedge clk) begin
		...
		case (STATE_LCD_CHANGE)
			...
			BATTLESHIP_PRESS_TO_ATTACK: begin
				out <= BATTLESHIP_PRESS_TO_ATTACK_STRING[index];
			end
			BATTLESHIP_SELECT_ROW: begin
				out <= BATTLESHIP_SELECT_ROW_STRING[index];
			end
			BATTLESHIP_SELECT_COLUMN: begin
				out <= BATTLESHIP_SELECT_COLUMN_STRING[index];
			end
			BATTLESHIP_SHOW_ATTACKED: begin
				out <= BATTLESHIP_SHOW_ATTACKED_STRING[index];
			end
			BATTLESHIP_ALREADY_ATTACKED: begin
				out <= BATTLESHIP_ALREADY_ATTACKED_STRING[index];
			end
			default: begin
				out <= CHAR_HYPHEN;
			end
