...
module LCD_display_string(clk, wlcd, index, PC, OPCODE, DATA, out);
	...
	localparam [CHAR_WIDTH-1:0] KERNEL_MENU_MEM = 8'd4;
	localparam [CHAR_WIDTH-1:0] KERNEL_MENU_MEM_LOAD = 8'd5;
	localparam [CHAR_WIDTH-1:0] KERNEL_MENU_MEM_DEL = 8'd6;
	localparam [CHAR_WIDTH-1:0] KERNEL_MENU_EXE = 8'd7;
	localparam [CHAR_WIDTH-1:0] KERNEL_MENU_EXE_N_PREEMPTIVO = 8'd8;
	localparam [CHAR_WIDTH-1:0] KERNEL_MENU_EXE_BLOCKED = 8'd9;
